_base_ = [
    ...
    '/opt/ml/input/code/mmsegmentation/configs/_gu_/_base_/fcn_hr48_runtime_wandb.py', '/opt/ml/input/code/mmsegmentation/configs/_gu_/_base_/schedules/schedule_320k.py'
]
