...
img_dir='/opt/ml/input/data/mmseg/img_dir_fold0/'
ann_dir= '/opt/ml/input/data/mmseg/ann_dir_fold0/'
...
albu_train_transforms = [
    ...
    # dict(type='GaussNoise', var_limit=(0.0, 0.04), mean=0, per_channel=True, always_apply=False, p=1.0),
