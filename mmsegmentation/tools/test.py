...
def parse_args():
    ...
    parser.add_argument('--config', default='/opt/ml/input/level2_semanticsegmentation_cv-level2-cv-07/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_fp32/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_fp32.py',help='test config file path')
    parser.add_argument('--checkpoint',default='/opt/ml/input/level2_semanticsegmentation_cv-level2-cv-07/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_fp32/best_mIoU_iter_13300.pth', help='checkpoint file')
    parser.add_argument(
        '--work_dir',
