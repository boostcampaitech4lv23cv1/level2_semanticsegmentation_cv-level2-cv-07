...
def parse_args():
    ...
    parser.add_argument('--config', default='/opt/ml/level2_semanticsegmentation_cv-level2-cv-07/mmsegmentation/work_dirs/base_upernet_convnext_xlarge_fp16_640x640_160k_ade20k_3/base_upernet_convnext_xlarge_fp16_640x640_160k_ade20k_3.py',help='test config file path')
    parser.add_argument('--checkpoint',default='/opt/ml/level2_semanticsegmentation_cv-level2-cv-07/mmsegmentation/work_dirs/base_upernet_convnext_xlarge_fp16_640x640_160k_ade20k_3/best_mIoU_iter_6867.pth', help='checkpoint file')
    parser.add_argument(
        '--work_dir',
